...
import 'package:lab10_app_126/page/add_product.dart';
import 'package:lab10_app_126/page/edit_product.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> getList() async {
    products = [];
    var url = Uri.parse('https://642021126.pungpingcoding.online/api/product');
        ...
        actions: [
          Row(
            children: [
              ...
              Text('$username', style: const TextStyle(color: Colors.orange)),
            ],
          ),
          IconButton(
            onPressed: () async {
  ...
  Future<void> deleteProduct(int id) async {
    var url =
        Uri.parse('https://642021126.pungpingcoding.online/api/product/$id');
  ...
  Future<void> logout(BuildContext context) async {
    ...
    var url = Uri.parse('https://642021126.pungpingcoding.online/api/logout');
